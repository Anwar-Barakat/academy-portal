...
@section('title')
    {{ __('msgs.update', ['name' => __('fee.payment')]) }}
@stop
        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('student-payments.update', $studentPayment) }}"
                        autocomplete="off">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="col-md-12 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <x-input type="number" id="amount" name="amount" :value="old('amount', $studentPayment->amount)"
                                        class="form-control" />
                                    @error('amount')
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="description" id="description" rows="3">{{ old('description', $studentPayment->description) }}</textarea>
                                    @error('description')
                                        <small class="text text-danger font-weight-bold">{{ $message }}</small>
                                    @enderror
                                </div>
