...
<head>
    ...
    <title>{{ __('trans.an_school') }} | {{ __('trans.login') }}</title>
                ...
                <div class="row justify-content-center no-gutters vertical-align">
                    <div class="col-lg-4 col-md-6 login-fancy-bg bg"
                        ...
                        <div class="login-fancy">
                            <h1 class="text-white mb-20 ">{{ __('trans.hello_world') }}</h1>
                            <p class="mb-20 text-white">{{ __('trans.welcome_to') }} {{ __('trans.an_school') }}</p>
                        ...
                        <div class="login-fancy pb-40 clearfix">
                            @if ($type == 'student')
                                <h3 style="font-family: 'Cairo', sans-serif" class="mb-30">
                                    {{ __('student.student') }} {{ __('trans.login') }} </h3>
                            @elseif($type == 'parent')
                                <h3 style="font-family: 'Cairo', sans-serif" class="mb-30">
                                    {{ __('parent.parent') }} {{ __('trans.login') }}
                                </h3>
                            @elseif($type == 'teacher')
                                <h3 style="font-family: 'Cairo', sans-serif" class="mb-30">
                                    {{ __('teacher.teacher') }} {{ __('trans.login') }} </h3>
                            @else
                                <h3 style="font-family: 'Cairo', sans-serif" class="mb-30">
                                    {{ __('trans.admin') }} {{ __('trans.login') }} </h3>
                            @endif
